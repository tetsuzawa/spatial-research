...
def main():
    ...
    # 刺激の変化を記録
    X_list = [290, 250, 200, 160, 130, 100, 80, 70, 50, 100, 90, 80, 80, 70, 70, 60, 60, 80, 70, 70, 70, 70, 70, 70, 70,
              70, 70,
              50, 70, 70]
    result_list = ['Correct', 'Correct', 'Correct', 'Correct', 'Correct', 'Correct', 'Correct', 'Correct', 'Incorrect',
                   'Correct',
