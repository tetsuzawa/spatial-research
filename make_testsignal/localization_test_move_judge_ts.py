...
for test_num in range(len(test_sounds)):
    while True:
        ...
        # 回答の入力
        if answer is 111 or answer is 000:
            with open(SCRIPT_DIR+subject+"/ANSWER/answer_"+subject+"_"+times+".csv", 'a') as answer_file:
                if answer is 111: answer = "c"
                elif answer is 000: answer = "cc"  
                ...
                answer_file.write(test_sounds[test_num] + "," + move_width + "," + move_time \
                    + "," + start_pos + "," + rotation_direction  + "," + answer + "," + is_correct + "\n")
                break
