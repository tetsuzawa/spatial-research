...
def main():
    ...
    sounds = []
    for i in r:
        sounds.append(dxx.read(f"SLTF_{i}_R_multiple_of_32.DDB"))

    arg_maxs = []
    maxs = []

    # t = np.arange(len(r)) / 48000 * 1000 / 32

    for sound in sounds:
        arg_maxs.append(np.argmax(sound) / 48000 * 1000 / 32)
